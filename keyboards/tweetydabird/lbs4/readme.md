...
* nanoBoot - A tiny 512 byte bootloader giving far more usable memory for features (This can be used on both Elite C and Pro Micro controller, but requires flashing the new bootloader).
